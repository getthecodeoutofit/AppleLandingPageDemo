...
Files: macbook-16.glb [639.28KB] > /home/ravi/threeUI/appleWeb/public/MacbookModel16s/macbook-16-transformed.glb [629.72KB] (1%)
Author: jackbaeten (https://sketchfab.com/jackbaeten)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-MacbookModel16s/macbook-pro-m3-16-inch-2024-8e34fc2b303144f78490007d91ff57c4
...
export function MacbookModel16(props) {
  ...
  useEffect(()=>{
    scene.traverse((child)=>{
      if (child.isMesh){
        //change the color only if the part name is not in the list(noChangeParts)
